...
static Image GenerateCard(Card card)
{
    ...
    g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.f, lc.s, LinearGradientMode.Horizontal), 5), 0, 200, 200, 200);
    g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.s, lc.f, LinearGradientMode.Horizontal), 5), 200, 200, 300, 200);

    g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.f, lc.s, LinearGradientMode.Horizontal), 5), 0, 250, 200, 250);
    g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.s, lc.f, LinearGradientMode.Horizontal), 5), 200, 250, 300, 250);

    if (card.Type != CardType.Test)
    {
        g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.f, lc.s, LinearGradientMode.Horizontal), 5), 0, 400, 200, 400);
        g.DrawLine(new Pen(new LinearGradientBrush(new Rectangle(0, 0, 200, 50), lc.s, lc.f, LinearGradientMode.Horizontal), 5), 200, 400, 300, 400);
    }
    ...
    g.DrawString(card.Name, new Font(family, 18, FontStyle.Bold), Brushes.Black, 10, 215);

    g.DrawString(card.Description, new Font(family, 12), Brushes.Black, new Rectangle(5, 260, 290, 190), new StringFormat { Alignment = StringAlignment.Center });
